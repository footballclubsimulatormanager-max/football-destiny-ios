...
private let FDEuropeSeeds: [FDClubSeed] = [
    // Angleterre — Premier League (2026-27)
    ...
    .init(name:"Leeds United", city:"Leeds", country:"Angleterre", continent:"Europe", division:1),
    .init(name:"Sunderland", city:"Sunderland", country:"Angleterre", continent:"Europe", division:1),
    .init(name:"Coventry City", city:"Coventry", country:"Angleterre", continent:"Europe", division:1),
    .init(name:"Ipswich Town", city:"Ipswich", country:"Angleterre", continent:"Europe", division:1),
    .init(name:"Hull City", city:"Hull", country:"Angleterre", continent:"Europe", division:1),
    // Angleterre — Championship (D2, 2026-27)
    .init(name:"West Ham United", city:"Londres", country:"Angleterre", continent:"Europe", division:2),
    .init(name:"Wolverhampton Wanderers", city:"Wolverhampton", country:"Angleterre", continent:"Europe", division:2),
    .init(name:"Burnley", city:"Burnley", country:"Angleterre", continent:"Europe", division:2),
    .init(name:"Leicester City", city:"Leicester", country:"Angleterre", continent:"Europe", division:2),
    .init(name:"Southampton", city:"Southampton", country:"Angleterre", continent:"Europe", division:2),
    ...
    // ---------------------------------------------------------------------------
    // France — the reference pyramid, the only country modelled down to four tiers.
    // Composition is the 2026-27 season: Ligue 1 and Ligue 2 at 18 clubs each, and the
    // former Championnat National, professional and renamed "Ligue 3" from this season.
    // Division 4 stands in for the semi-pro/regional level (National 2 & 3) and is a
    // representative selection rather than the full 60+ club list.
    // ---------------------------------------------------------------------------
    ...
    .init(name:"FC Lorient", city:"Lorient", country:"France", continent:"Europe", division:1),
    .init(name:"Paris FC", city:"Paris", country:"France", continent:"Europe", division:1),
    .init(name:"ESTAC Troyes", city:"Troyes", country:"France", continent:"Europe", division:1),
    .init(name:"Le Mans FC", city:"Le Mans", country:"France", continent:"Europe", division:1),

    // France — Ligue 2 (D2)
    .init(name:"FC Nantes", city:"Nantes", country:"France", continent:"Europe", division:2),
    .init(name:"FC Metz", city:"Metz", country:"France", continent:"Europe", division:2),
    .init(name:"Stade de Reims", city:"Reims", country:"France", continent:"Europe", division:2),
    .init(name:"Montpellier HSC", city:"Montpellier", country:"France", continent:"Europe", division:2),
    ...
    .init(name:"Clermont Foot 63", city:"Clermont-Ferrand", country:"France", continent:"Europe", division:2),
    .init(name:"USL Dunkerque", city:"Dunkerque", country:"France", continent:"Europe", division:2),
    .init(name:"Pau FC", city:"Pau", country:"France", continent:"Europe", division:2),
    .init(name:"Rodez AF", city:"Rodez", country:"France", continent:"Europe", division:2),
    .init(name:"FC Annecy", city:"Annecy", country:"France", continent:"Europe", division:2),
    .init(name:"Red Star FC", city:"Saint-Ouen", country:"France", continent:"Europe", division:2),
    .init(name:"AS Nancy-Lorraine", city:"Nancy", country:"France", continent:"Europe", division:2),
    .init(name:"US Boulogne", city:"Boulogne-sur-Mer", country:"France", continent:"Europe", division:2),
    .init(name:"Stade Lavallois", city:"Laval", country:"France", continent:"Europe", division:2),
    .init(name:"Dijon FCO", city:"Dijon", country:"France", continent:"Europe", division:2),
    .init(name:"FC Sochaux", city:"Montbéliard", country:"France", continent:"Europe", division:2),
    .init(name:"AS Saint-Étienne", city:"Saint-Étienne", country:"France", continent:"Europe", division:2),

    // France — Ligue 3 (D3, ex-Championnat National)
    .init(name:"Amiens SC", city:"Amiens", country:"France", continent:"Europe", division:3),
    .init(name:"SC Bastia", city:"Bastia", country:"France", continent:"Europe", division:3),
    .init(name:"SM Caen", city:"Caen", country:"France", continent:"Europe", division:3),
    .init(name:"Valenciennes FC", city:"Valenciennes", country:"France", continent:"Europe", division:3),
    .init(name:"US Orléans", city:"Orléans", country:"France", continent:"Europe", division:3),
    .init(name:"FC Rouen", city:"Rouen", country:"France", continent:"Europe", division:3),
    .init(name:"US Quevilly-Rouen", city:"Le Petit-Quevilly", country:"France", continent:"Europe", division:3),
    .init(name:"FC Versailles 78", city:"Versailles", country:"France", continent:"Europe", division:3),
    .init(name:"US Concarneau", city:"Concarneau", country:"France", continent:"Europe", division:3),
    .init(name:"FC Villefranche Beaujolais", city:"Villefranche-sur-Saône", country:"France", continent:"Europe", division:3),
    .init(name:"Football Bourg-en-Bresse 01", city:"Bourg-en-Bresse", country:"France", continent:"Europe", division:3),
    .init(name:"FC Fleury 91", city:"Fleury-Mérogis", country:"France", continent:"Europe", division:3),
    .init(name:"Le Puy Foot 43", city:"Le Puy-en-Velay", country:"France", continent:"Europe", division:3),
    .init(name:"Paris 13 Atletico", city:"Paris", country:"France", continent:"Europe", division:3),
    .init(name:"SC Aubagne Air Bel", city:"Aubagne", country:"France", continent:"Europe", division:3),
    .init(name:"AS Cannes", city:"Cannes", country:"France", continent:"Europe", division:3),
    .init(name:"VFC La Roche-sur-Yon", city:"La Roche-sur-Yon", country:"France", continent:"Europe", division:3),
    .init(name:"US Thionville Lusitanos", city:"Thionville", country:"France", continent:"Europe", division:3),

    // France — Régional 1 (D4, niveau National 2 / National 3)
    .init(name:"Nîmes Olympique", city:"Nîmes", country:"France", continent:"Europe", division:4),
    .init(name:"LB Châteauroux", city:"Châteauroux", country:"France", continent:"Europe", division:4),
    .init(name:"Stade Briochin", city:"Saint-Brieuc", country:"France", continent:"Europe", division:4),
    .init(name:"CS Sedan Ardennes", city:"Sedan", country:"France", continent:"Europe", division:4),
    .init(name:"US Créteil-Lusitanos", city:"Créteil", country:"France", continent:"Europe", division:4),
    .init(name:"FC Chambly Oise", city:"Chambly", country:"France", continent:"Europe", division:4),
    .init(name:"AS Beauvais Oise", city:"Beauvais", country:"France", continent:"Europe", division:4),
    .init(name:"SAS Épinal", city:"Épinal", country:"France", continent:"Europe", division:4),
    .init(name:"Bourges Foot 18", city:"Bourges", country:"France", continent:"Europe", division:4),
    .init(name:"US Saint-Malo", city:"Saint-Malo", country:"France", continent:"Europe", division:4),
    .init(name:"Vannes OC", city:"Vannes", country:"France", continent:"Europe", division:4),
    .init(name:"GOAL FC", city:"Chasselay", country:"France", continent:"Europe", division:4),
    .init(name:"Hyères FC", city:"Hyères", country:"France", continent:"Europe", division:4),
    .init(name:"FC Istres", city:"Istres", country:"France", continent:"Europe", division:4),
    .init(name:"Angoulême CFC", city:"Angoulême", country:"France", continent:"Europe", division:4),
    .init(name:"Stade Poitevin", city:"Poitiers", country:"France", continent:"Europe", division:4),
    .init(name:"SO Cholet", city:"Cholet", country:"France", continent:"Europe", division:4),
    .init(name:"Les Herbiers VF", city:"Les Herbiers", country:"France", continent:"Europe", division:4),
    .init(name:"AS Saint-Priest", city:"Saint-Priest", country:"France", continent:"Europe", division:4),
    .init(name:"Andrézieux-Bouthéon FC", city:"Andrézieux-Bouthéon", country:"France", continent:"Europe", division:4),
    .init(name:"Jura Sud Foot", city:"Moirans-en-Montagne", country:"France", continent:"Europe", division:4),
    .init(name:"US Colomiers", city:"Colomiers", country:"France", continent:"Europe", division:4),
    .init(name:"Toulouse Rodéo FC", city:"Toulouse", country:"France", continent:"Europe", division:4),
    .init(name:"Racing Besançon", city:"Besançon", country:"France", continent:"Europe", division:4),
